 ...
 */
package org.jbh.flowcontroller.cli.commands;
...
public class FlowcontrollerCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(FlowcontrollerCliTestCommand.class);
    protected final FlowcontrollerCliCommands service;

    public FlowcontrollerCliTestCommand(final FlowcontrollerCliCommands service) {
