 ...
 */
package org.jbh.controller.cli.commands;
...
public class ControllerCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(ControllerCliTestCommand.class);
    protected final ControllerCliCommands service;

    public ControllerCliTestCommand(final ControllerCliCommands service) {
